          ...
          <div className="policy-content">
            ...
            <div className="policy-desc">
              <div className="policy-container">
                ...
                <p className="policy-desc__content">- To make a reservation, you must be at least 18 years old.</p>
              ...
              <div className="policy-container">
                ...
                <p className="policy-desc__content">
                  - We respect your privacy. Personal information provided during the booking process will only be used
                  for reservation purposes and will not be shared with third parties.
                </p>
              </div>
              <div className="policy-container">
                <p className="policy-desc__header">7. Force Majeure:</p>
                <p className="policy-desc__content">
                  - Birthday Blitz Hub is not liable for any failure or delay in performance due to circumstances beyond
                  our control, such as natural disasters, strikes, or government actions. If any of the above
                  circumstances does occurred, you can contact our associated host to make changes.
                </p>
              </div>
              <div className="policy-container">
                <p className="policy-desc__header">8. Feedback and Reviews:</p>
                <p className="policy-desc__content">
                  - We encourage guests to provide feedback and reviews about their experience. Your insights help us
